...
GoPro::GoPro(QObject *parent) : QObject(parent) {}
...
void GoPro::goProSettings(const int &goProSelect, const QString &goPropass)
{
    ...
    if (Index == 1) {
        ...
        PARAM1 = "bacpac";
        PARAM2 = "SH";
        Command = QString(ADRESS) + QString(PARAM1) + "/" + QString(PARAM2) + "?t=" + QString(PASSWORD) + "&p=%" + "0" +
                  QString(OPTION);
    }
    ...
    if (Index == 3) {
        PARAM1 = "camera";
        PARAM2 = "SH";
        Command = QString(ADRESS) + QString(PARAM1) + "/" + QString(PARAM2) + "?t=" + QString(PASSWORD) + "&p=%" +
                  QString(OPTION);
    }
