...
Extender::Extender(QObject *parent) : QObject(parent), m_dashboard(nullptr) {}
Extender::Extender(DashBoard *dashboard, QObject *parent) : QObject(parent), m_dashboard(dashboard) {}
        ...
        */
        if (frame.frameId() == adress1) {
            ...
            if (m_dashboard->RPMFrequencyDividerDi1() > 0) {
                ...
                m_dashboard->setfrequencyDIEX1(qRound((avghz1 / 10) * 16.6 * 60) /
                                               m_dashboard->RPMFrequencyDividerDi1());
            }
        }
